...
$(".boot").mouseenter(function(){
	     $(this).animate({"padding-right": "10px"}, 1000);
	    $(".cicloBoot").animate({"background-position":"0px"},100);
             console.log("entro aqui boot")
});

$(".boot").mouseleave(function(){
     $(this).animate({"padding-right": "0px"}, 1000);
...
$(".sourceT").mouseenter(function(){
	 $(this).animate({"padding-right": "10px"}, 100);
	 $(".cicloSourceT").animate({"background-position":"0px"},100);
             console.log("entro aqui sourceT")
});

$(".sourceT").mouseleave(function(){
     $(this).animate({"padding-right": "0px"}, 100);
...
$(".excel").mouseenter(function(){
    $(this).animate({"padding-right": "10px"}, 100);
    $(".cicloExcel").animate({"background-position":"0px"},100);
             console.log("entro aqui excel")
});
...
$(".outlook").mouseenter(function(){
	    ...
	    $(".cicloOutlook").animate({"background-position":"0px"},100);
             console.log("entro aqui outlook")
});
