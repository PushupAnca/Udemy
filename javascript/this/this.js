...
function color(){
	this.classList.toggle('negro'); // esta 'this' caja la que esta cliqueada se le quita una clase, indepenedientemente de la que tiene, 
	// una se quita y otra se le añade. 
}
